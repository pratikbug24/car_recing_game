...
public class Game extends JPanel{
    ...
    public Game(){
        crx = cry = -1999;   //initialing setting the location of the crossing to (-999,-999)
    ...
    public void paint(Graphics g){
        ...
        try{
            ...
            if(cry >= -499 && crx >= -499) //if a road crossing has passed the window view
                obj.drawImage(getToolkit().getImage("images/st_road.png"),crx,cry,this); //draw another road crossing on window
    ...
    void moveRoad(int count){
        if(crx == -1999 && cry == -1999){ //if the road crossing has passed by
        ...
        if(crx == -499 && cry == 0){ //if the opponent car passes the user without colliding
            crx = cry = -1999;   //reset opponent car position to beginning to start over
        }
    ...
    public static void main(String args[]){
        ...
        frame.setSize(1500,1500); //setting size of screen to 500x500
        ...
        while(true){
            ...
            if(game.nOpponent < 4 && count % 200 == 0){ //if there is less than 4 cars and count timer reaches 200
                ...
                game.lx[game.nOpponent] = 1499; //set opponent cars start positions
